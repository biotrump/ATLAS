...
cat res/t${pre}gemm${bl}_200_2000_200_20.out \
    res/t${pre}gemm${bl}_3000_6000_1000_4.out ${eb} \
    | $BINdir/tvecget -H 2 N MFLOP \
    | $BINdir/tvecreduce -R 1 N_gemm -C 1 MFLOP_gemm -o $t0
cat res/t${pre}getrf${la}${bl}_200_2000_200_20.out \
    res/t${pre}potrf${la}${bl}_200_2000_200_20.out \
    res/t${pre}geqrf${la}${bl}_200_2000_200_20.out \
    res/t${pre}getrf${la}${bl}_3000_6000_1000_4.out \
    res/t${pre}potrf${la}${bl}_3000_6000_1000_4.out \
    res/t${pre}geqrf${la}${bl}_3000_6000_1000_4.out ${el} \
    | $BINdir/tvecget -H 2 N MFLOP \
